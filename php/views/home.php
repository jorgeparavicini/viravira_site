...
<h1 id="title">Welcome to Vira Vira</h1>
...
<section>
    <h2>Explore Vira Vira</h2>
    <div class="cards">
        <a class="card info" href="location.php">
            <img src="/img/icons/location.svg" alt="locations svg" class="icon"/>
        ...
        <a class="card info" href="/excursions">
            <img src="/img/icons/excursions.svg" alt="excursions svg" class="icon"/>
        ...
        <a class="card info" href="spa.php">
            <img src="/img/icons/spa.svg" alt="spa icon" class="icon"/>
        ...
        <a class="card info" href="gallery.php">
            <img src="/img/icons/gallery.svg" alt="Gallery Icon" id="galleryIcon" class="icon">
            <h3 class="title">Gallery</h3>
            <div class="excerpt">
                Visit our gallery
            </div>
        </a>
        <a class="card info" href="contact.php">
            <img src="/img/icons/contactUs.svg" alt="Contact Us" id="contactUsIcon" class="icon">
